...
impl OpCode {
    pub fn new(code: u8, name: &'static str, bytes: usize, cycles: usize, mode: AddressingMode) -> Self {
        Self { code: code, name: name, bytes: bytes, cycles: cycles, mode: mode }
    }
}
...
lazy_static! {
    pub static ref CPU_OPS_CODES: Vec<OpCode> = vec![
        ...
        // inc
        OpCode::new(0xe6, "DEC", 2, 5, AddressingMode::ZeroPage),
        OpCode::new(0xf6, "DEC", 2, 6, AddressingMode::ZeroPage_X),
        OpCode::new(0xee, "DEC", 3, 6, AddressingMode::Absolute),
        OpCode::new(0xfe, "DEC", 3, 7, AddressingMode::Absolute_X),

        // iny
        OpCode::new(0xe8, "DEY", 1, 2, AddressingMode::NoneAddressing),

        /* transfer */
        OpCode::new(0xaa, "TAX", 1, 2, AddressingMode::NoneAddressing),
        OpCode::new(0xa8, "TAY", 1, 2, AddressingMode::NoneAddressing),
        OpCode::new(0x8a, "TAX", 1, 2, AddressingMode::NoneAddressing),
        OpCode::new(0x98, "TAY", 1, 2, AddressingMode::NoneAddressing),
